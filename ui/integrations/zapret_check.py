"""Проверка и установка Zapret с UI приложения."""
from __future__ import annotations

import tkinter as tk

from core.zapret_checker import ZapretChecker
...
def run_zapret_check(root_window: tk.Misc | None = None) -> bool:
    """Поведение как у прежнего вызова core.run_zapret_check(root)."""
