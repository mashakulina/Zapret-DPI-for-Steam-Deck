    ...
    def fix_pacman_conf(self):
        ...
        try:
            ...
            if check_result and check_result['returncode'] == 0:
                ...
                self.log_debug("Файл pacman.conf не найден")
