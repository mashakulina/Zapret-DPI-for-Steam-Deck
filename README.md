...
Стратегии и некоторые доработки берутся из версии Zapret для Windows от [Flowseal](https://github.com/Flowseal)
...
5. Ввести sudo пароль, когда появится окно для ввода пароля
